...
def main():
    ...
    params = {
        "api_token": TOKEN,
        "include": "type;player:name;participant:name",
        "filters": "seasonTopscorerTypes:209",
    }
    ...
    out_path = save_json(payload, f"top_assist_providers_league{LEAGUE_ID}_season{SEASON_ID}_{ts}.json")
    ...
    for row in data[:25]:
        ...
        assists = row.get("total")
        print(f"- {player_name} — {team_name} — {assists}")
